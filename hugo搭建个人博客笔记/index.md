...
1. windows 电脑安装 hugo
   ...
   接下来需要配置环境变量，鼠标右键我的电脑-属性-高级系统设置-环境变量-系统变量-双击 path-新建，然后江 hugo.exe 的位置输入进去，这里我输入的就是”D:\hugo\bin“。
...
4. 使用 vs code 建立博客
   ...
   在复制完六百多行的代码后，我们可以适当删改里面的部分内容，让网页显示为我们希望它显示的那样，举个例子：

   ![70988401168](/images/1709884152161.png)

   这里我修改了主页的头像、网站的标题以及副标题，具体效果如下：
